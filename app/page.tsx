...
const Home = () => {
  return (
    <div className="h-full">
      <section className="flex flex-col-reverse  lg:flex-none lg:grid lg:grid-cols-2 items-center mt-12 mx-4 sm:mx-5 lg:mx-6 xl:mx-0">
        <div>
          ...
          <div className="flex flex-col w-full justify-start mt-6 lg:mt-8">
            <div className="flex items-center gap-2 text-xs sm:text-lg lg:text-lg font-medium">
              <Truck width={40} height={40} />
              <p className="flex flex-col sm:flex-row gap-1 lg:gap-1 w-full cursor-pointer hover:underline underline-offset-1">
            ...
            <div className="relative h-6 w-62 ml-8 mt-2 lg:mt-0">
              <Image
                src="/payments.png"
        ...
        <div className="flex justify-end">
          <div className="h-80 w-80 lg:h-100 lg:w-100 xl:h-120 xl:w-120 relative">
            <Image
              src="/product.png"
